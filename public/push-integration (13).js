  ...
  if (theme.animation && theme.animation !== 'none') {
    ...
    style.textContent = \`      @keyframes slideInFromTop {
      ...
      @keyframes slideInFromRight {
        from { transform: translateX(0%) translateY(-50%); opacity: 0; }
        to { transform: translateX(-50%) translateY(-50%); opacity: 1; }
      }
      @keyframes fadeIn {
        from { opacity: 0; }
      ...
      @keyframes bounceIn {
        0% { transform: translateX(-50%) translateY(-50%) scale(0.3); opacity: 0; }
        50% { transform: translateX(-50%) translateY(-50%) scale(1.05); opacity: 1; }
        70% { transform: translateX(-50%) translateY(-50%) scale(0.9); }
        100% { transform: translateX(-50%) translateY(-50%) scale(1); opacity: 1; }
      }
      @keyframes zoomIn {
        from { transform: translateX(-50%) translateY(-50%) scale(0.5); opacity: 0; }
